...
class ComponentServiceRegisterEvent(
    ...
    private val instanceRegistry: ComponentServiceDSL = root.run { "root" isMulti true cs "player" isMulti true cs "multi-player" isMulti true csc { "player-instance" cs "default" } },
