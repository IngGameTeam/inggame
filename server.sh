...
cd ..
java -Xms4G -Xmx4G -Djava.compiler=jitc -XX:ReservedCodeCacheSize=2G -XX:InitialCodeCacheSize=2G -XX:CompileThreshold=1 -XX:TieredStopAtLevel=1 -jar --add-modules jdk.incubator.vector server.jar
