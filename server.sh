...
java -Xms2G -Xmx2G -XX:CompileThreshold=1 -XX:CompilationPolicyChoice=2 -XX:TieredCompilation -XX:TieredStopAtLevel=1 -jar --add-modules jdk.incubator.vector server.jar
